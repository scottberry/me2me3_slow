...
time_file <- paste("t_s",s,"ctrl",ctrl,"cc",cc,astr,fstr,taustr,"st",st,".txt",sep="")
tDep_me2_file <- paste("me2_t_s",s,"ctrl",ctrl,"cc",cc,astr,fstr,taustr,"st",st,".txt",sep="")
tDep_me3_file <- paste("me3_t_s",s,"ctrl",ctrl,"cc",cc,astr,fstr,taustr,"st",st,".txt",sep="")
tDep_firing_file <- paste("Firing_t_s",s,"ctrl",ctrl,"cc",cc,astr,fstr,taustr,"st",st,".txt",sep="")
tDep_me2_LIGHT_file <- paste("LIGHT_me2_t_s",s,"ctrl",ctrl,"cc",cc,astr,fstr,taustr,"st",st,".txt",sep="")
tDep_me2_HEAVY_file <- paste("HEAVY_me2_t_s",s,"ctrl",ctrl,"cc",cc,astr,fstr,taustr,"st",st,".txt",sep="")
tDep_me2_UNLABELLED_file <- paste("UNLABELLED_me2_t_s",s,"ctrl",ctrl,"cc",cc,astr,fstr,taustr,"st",st,".txt",sep="")
tDep_me3_LIGHT_file <- paste("LIGHT_me3_t_s",s,"ctrl",ctrl,"cc",cc,astr,fstr,taustr,"st",st,".txt",sep="")
tDep_me3_HEAVY_file <- paste("HEAVY_me3_t_s",s,"ctrl",ctrl,"cc",cc,astr,fstr,taustr,"st",st,".txt",sep="")
tDep_me3_UNLABELLED_file <- paste("UNLABELLED_me3_t_s",s,"ctrl",ctrl,"cc",cc,astr,fstr,taustr,"st",st,".txt",sep="")
...
# 
# silacAbs_file <- paste("SilacAbs_s",s,"ctrl",ctrl,"cc",cc,astr,fstr,taustr,"st",st,".txt",sep="")
# silacRel_file <- paste("SilacRel_s",s,"ctrl",ctrl,"cc",cc,astr,fstr,taustr,"st",st,".txt",sep="")
# 
