...
parameterSpace_file <- paste("ParamOptimRes_s",s,"ctrl",ctrl,"cc",cc,fstr,rep,"_st",st,id,".txt",sep="")
...
parameterSpace[parameterSpace$bistability==max(parameterSpace$bistability),]
