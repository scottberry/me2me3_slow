...
time_file <- paste("t_s",s,"ctrl",ctrl,"cc",cc,astr,bstr,fstr,turnstr,pstr,rep,"_st",st,id,".txt",sep="")
tDep_me0_file <- paste("me0_t_s",s,"ctrl",ctrl,"cc",cc,astr,bstr,fstr,turnstr,pstr,rep,"_st",st,id,".txt",sep="")
tDep_me1_file <- paste("me1_t_s",s,"ctrl",ctrl,"cc",cc,astr,bstr,fstr,turnstr,pstr,rep,"_st",st,id,".txt",sep="")
tDep_me2_file <- paste("me2_t_s",s,"ctrl",ctrl,"cc",cc,astr,bstr,fstr,turnstr,pstr,rep,"_st",st,id,".txt",sep="")
tDep_me3_file <- paste("me3_t_s",s,"ctrl",ctrl,"cc",cc,astr,bstr,fstr,turnstr,pstr,rep,"_st",st,id,".txt",sep="")
#tDep_H3_1_file <- paste("H3_1_t_s",s,"ctrl",ctrl,"cc",cc,astr,bstr,fstr,turnstr,pstr,rep,"_st",st,id,".txt",sep="")
#tDep_H3_3_file <- paste("H3_3_t_s",s,"ctrl",ctrl,"cc",cc,astr,bstr,fstr,turnstr,pstr,rep,"_st",st,id,".txt",sep="")
tDep_firing_file <- paste("Firing_t_s",s,"ctrl",ctrl,"cc",cc,astr,bstr,fstr,turnstr,pstr,rep,"_st",st,id,".txt",sep="")
...
## Plot alpha
# 
# alpha_file <- paste("alpha_s",s,"ctrl",ctrl,"cc",cc,astr,bstr,fstr,turnstr,pstr,rep,"_st",st,id,".txt",sep="")
